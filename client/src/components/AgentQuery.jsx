 ...
 *
 * When the agent service is offline, displays a styled offline card instead of
 * a raw error string.
 */
    ...
    <div className="card">
      ...
      {isOffline && (
        <div className="agent-offline-card">
          ...
          <button className="btn" style={{ marginLeft: "auto", flexShrink: 0 }} onClick={run}>
            Retry
          </button>
        </div>
      )}
      ...
      {err && !isOffline && (
        <div className="form-error" style={{ margin: "10px 0" }}>
          {err}
          <button className="btn" style={{ marginLeft: 12, padding: "6px 12px", fontSize: 12 }} onClick={run}>
            Retry
          </button>
        </div>
      )}
